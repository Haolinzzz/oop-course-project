...
class questions extends JPanel {
    ...
    questions(Question object, JFrame window) {

        Q = new JLabel(object.question);
        hintLabel = new JLabel("Hint");
        option1 = new JButton(object.op1);
        option2 = new JButton(object.op2);
        option3 = new JButton(object.op3);
        option4 = new JButton(object.op4);
        ...
        setLayout(null);
        setBackground(Color.getHSBColor(153, 253, 26));
        ...
        timer.setFont(new Font("Georgia", Font.BOLD, 40));
        ...
        });//50 50 button function: to eliminate two incorrect answer.

        window.setVisible(true);
    }

    void getAnswer(int time) throws Exception {
        ...
        while (next == false) {
            ...
            timer.setText(String.format("%02d", count.M) + " : "
                    + String.format("%02d", count.S) + " : "
